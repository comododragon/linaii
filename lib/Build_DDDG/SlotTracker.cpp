...
mdn_iterator SlotTracker::mdn_begin() { 
	return mdnMap.begin(); 
}

mdn_iterator SlotTracker::mdn_end() { 
	return mdnMap.end(); 
}

unsigned SlotTracker::mdn_size() const { 
	return mdnMap.size(); 
}

bool SlotTracker::mdn_empty() const { 
	return mdnMap.empty(); 
}

/// AttributeSet map iterators.
as_iterator SlotTracker::as_begin() { 
	return asMap.begin(); 
}

as_iterator SlotTracker::as_end() { 
	return asMap.end(); 
}

unsigned SlotTracker::as_size() const { 
	return asMap.size(); 
}

bool SlotTracker::as_empty() const { 
	return asMap.empty(); 
}
