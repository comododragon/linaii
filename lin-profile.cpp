...
const std::string helpMessage =
	...
	"                   --mem-trace        : obtain (in trace mode) or use (in estimate mode) full memory\n"
	"                                        trace for access pattern analysis. Prefer using\n"
	"                                        \"--short-mem-trace\" if possible\n"
	"                   --short-mem-trace  : obtain (in trace mode) or use (in estimate mode) short binary\n"
	"                                        memory trace for access pattern analysis. For large profilings,\n"
	"                                        this can be generated and processed faster than the full trace\n"
...
void parseInputArguments(int argc, char **argv) {
	...
	while(true) {
		static struct option longOptions[] = {
			...
			{"short-mem-trace", no_argument, 0, 0xF01},
