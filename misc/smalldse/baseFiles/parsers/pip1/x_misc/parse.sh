...
grep "Number of nodes:" $1 | tail -n 1 | sed "s/\t\tNumber of nodes: \\(.*\\)/\\1,/g" | tr -d "\n"
grep "Number of edges:" $1 | tail -n 1 | sed "s/\t\tNumber of edges: \\(.*\\)/\\1,/g" | tr -d "\n"
grep "Number of register dependencies:" $1 | tail -n 1 | sed "s/\t\tNumber of register dependencies: \\(.*\\)/\\1,/g" | tr -d "\n"
grep "Number of memory dependencies:" $1 | tail -n 1 | sed "s/\t\tNumber of memory dependencies: \\(.*\\)/\\1,/g" | tr -d "\n"

grep "		Latency:" $1 | tail -n 1 | sed "s/\t\tLatency: \\(.*\\)/\\1,/g" | tr -d "\n"
...
grep "^	IL:" $1 | tail -n 1 | sed "s/\tIL: \\(.*\\)/\\1,/g" | tr -d "\n"
grep "^	DSPs:" $1 | tail -n 1 | sed "s/\tDSPs: \\(.*\\)/\\1,/g" | tr -d "\n"
...
grep "^	fMul units:" $1 | tail -n 1 | sed "s/\tfMul units: \\(.*\\)/\\1,/g" | tr -d "\n"
grep "^	fDiv units:" $1 | tail -n 1 | sed "s/\tfDiv units: \\(.*\\)/\\1,/g" | tr -d "\n"
grep "^	II:" $1 | tail -n 1 | sed "s/\tII: \\(.*\\)/\\1,/g" | tr -d "\n"
grep "^	RecII:" $1 | tail -n 1 | sed "s/\tRecII: \\(.*\\)/\\1,/g" | tr -d "\n"
grep "^	ResIIMem:" $1 | tail -n 1 | sed "s/\tResIIMem: \\(.*\\) constrained.*/\\1,/g" | tr -d "\n"
grep "^	ResIIOp:" $1 | tail -n 1 | sed "s/\tResIIOp: \\(.*\\) constrained.*/\\1,/g" | tr -d "\n"
